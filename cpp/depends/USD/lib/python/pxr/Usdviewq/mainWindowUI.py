...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuView.addAction(self.actionAdjust_Free_Camera)
...
#endif // QT_CONFIG(shortcut)
        self.actionAdjust_Free_Camera.setText(QCoreApplication.translate("MainWindow", u"Adjust Free Camera...", None))
