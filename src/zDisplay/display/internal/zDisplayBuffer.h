...
#include <zspace/zCore/base/zDefinitions.h>
	...
	*/
	...
	public:
		...
		*/
		...
		/*! \brief This method appends the vertex attributes of position and normals(if available) to the buffer.
		*
		*	\param		[in]	_positions			- float pointer to vertex positions container.
		*	\param		[in]	_normals			- float pointer to vertex normals container.
		*	\param		[in]	numPositions		- number of positions.
		*	\since version 0.0.1
		*/
		int appendVertexAttributes(float* _positions, float* _normals, int numPositions);
		...
		*/
		...
		/*! \brief This method appends the vertex color attribute to the buffer.
		*
		*	\param		[in]	_colors				- float pointer to vertex colors container.
		*	\param		[in]	numPositions		- number of positions.
		*	\since version 0.0.1
		*/
		int appendVertexColors(float* _colors, int numPositions);
		...
		*	\since version 0.0.1
		*/
		void updateVertexPositions(float* _positions, int numPositions, int startId);
		...
		*	\since version 0.0.1
		*/
		void updateVertexNormals(float* _normals, int numPositions, int& startId);
		...
		*	\since version 0.0.1
		*/
		void updateVertexColors(float* _colors, int numPositions, int& startId);
