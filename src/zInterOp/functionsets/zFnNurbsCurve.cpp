...
namespace zSpace
{
	...
	ZSPACE_INLINE void zFnNurbsCurve::getBounds(zPoint &minBB, zPoint &maxBB)
	{
		...
		nurbsCurveObj->getDisplayPositions(positions);
	...
	{
		zPointArray empty;
		nurbsCurveObj->displayPositions = empty;
	...
	ZSPACE_INLINE void zFnNurbsCurve::create(zPointArray& positions, int degree, bool periodic, bool interpolate, int displayNumPoints)
	{
		...
		nurbsCurveObj->displayControlPointPositions = positions;
	...
	ZSPACE_INLINE void zFnNurbsCurve::computeSubCurve(double t0, double t1, bool normalise, zObjectNurbsCurve& out_SubCurve, int displayNumPoints)
	{
		...
		out_SubCurve.displayControlPointPositions = positions;
	}
	...
	ZSPACE_INLINE void zFnNurbsCurve::setDisplayNumPoints(int _numPoints)
	{
		...
		nurbsCurveObj->displayPositions = displayPositions;
	}
	...
	ZSPACE_INLINE void zFnNurbsCurve::transformObject(zTransform &transform)
	{
		...
		nurbsCurveObj->displayControlPointPositions = displayControlPoints;
