...
#include<zspace/zInterface/iterators/zItPointField.h>
...
namespace zSpace
{
	...
	ZSPACE_INLINE zItPointScalarField::zItPointScalarField(zObjectPointScalarField &_fieldObj)
	{
		fieldObj = &_fieldObj;
	...
	ZSPACE_INLINE zItPointScalarField::zItPointScalarField(zObjectPointScalarField &_fieldObj, int _index)
	{
		fieldObj = &_fieldObj;
		iter = fieldObj->field.fieldValues.begin();
	...
	ZSPACE_INLINE zItPointScalarField::zItPointScalarField(zObjectPointScalarField &_fieldObj, zVector &_pos, bool closestIndex)
	{
		fieldObj = &_fieldObj;
		iter = fieldObj->field.fieldValues.begin();
	...
	ZSPACE_INLINE zItPointScalarField::zItPointScalarField(zObjectPointScalarField &_fieldObj, int _index_X, int _index_Y, int _index_Z)
	{
		fieldObj = &_fieldObj;
		iter = fieldObj->field.fieldValues.begin();
...
namespace zSpace
{
	...
	ZSPACE_INLINE zItPointVectorField::zItPointVectorField(zObjectPointVectorField &_fieldObj)
	{
		fieldObj = &_fieldObj;
		iter = fieldObj->field.fieldValues.begin();
	...
	ZSPACE_INLINE zItPointVectorField::zItPointVectorField(zObjectPointVectorField &_fieldObj, int _index)
	{
		fieldObj = &_fieldObj;
		iter = fieldObj->field.fieldValues.begin();
	...
	ZSPACE_INLINE zItPointVectorField::zItPointVectorField(zObjectPointVectorField &_fieldObj, zVector &_pos, bool closestIndex)
	{
		fieldObj = &_fieldObj;
		iter = fieldObj->field.fieldValues.begin();
	...
	ZSPACE_INLINE zItPointVectorField::zItPointVectorField(zObjectPointVectorField &_fieldObj, int _index_X, int _index_Y)
	{
		fieldObj = &_fieldObj;
		iter = fieldObj->field.fieldValues.begin();
