...
namespace zSpace
{
	...
	ZSPACE_INLINE zItMeshScalarField::zItMeshScalarField(zObjectMeshScalarField &_fieldObj)
	{
		fieldObj = &_fieldObj;
	...
	ZSPACE_INLINE zItMeshScalarField::zItMeshScalarField(zObjectMeshScalarField &_fieldObj, int _index)
	{
		fieldObj = &_fieldObj;
		iter = fieldObj->field.fieldValues.begin();
	...
	ZSPACE_INLINE zItMeshScalarField::zItMeshScalarField(zObjectMeshScalarField &_fieldObj, zVector &_pos, bool closestIndex)
	{
		fieldObj = &_fieldObj;
		iter = fieldObj->field.fieldValues.begin();
	...
	ZSPACE_INLINE zItMeshScalarField::zItMeshScalarField(zObjectMeshScalarField &_fieldObj, int _index_X, int _index_Y)
	{
		fieldObj = &_fieldObj;
		iter = fieldObj->field.fieldValues.begin();
...
namespace zSpace
{
	...
	ZSPACE_INLINE zItMeshVectorField::zItMeshVectorField(zObjectMeshVectorField &_fieldObj)
	{
		fieldObj = &_fieldObj;
		iter = fieldObj->field.fieldValues.begin();
	...
	ZSPACE_INLINE zItMeshVectorField::zItMeshVectorField(zObjectMeshVectorField &_fieldObj, int _index)
	{
		fieldObj = &_fieldObj;
		iter = fieldObj->field.fieldValues.begin();
	...
	ZSPACE_INLINE zItMeshVectorField::zItMeshVectorField(zObjectMeshVectorField &_fieldObj, zVector &_pos, bool closestIndex)
	{
		fieldObj = &_fieldObj;
		iter = fieldObj->field.fieldValues.begin();
	...
	ZSPACE_INLINE zItMeshVectorField::zItMeshVectorField(zObjectMeshVectorField &_fieldObj, int _index_X, int _index_Y)
	{
		fieldObj = &_fieldObj;
		iter = fieldObj->field.fieldValues.begin();
