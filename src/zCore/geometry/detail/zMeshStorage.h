...
#ifndef ZSPACE_DETAIL_MESH_STORAGE_H
#define ZSPACE_DETAIL_MESH_STORAGE_H
...
namespace zSpace
{
	...
	*/
	...
	class ZSPACE_CORE zMesh : public detail::zHalfEdgeTopology
	{
...
#else
#include<src/zCore/geometry/zMesh.cpp>
#endif
