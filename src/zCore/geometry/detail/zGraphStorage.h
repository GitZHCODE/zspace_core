...
#ifndef ZSPACE_DETAIL_GRAPH_STORAGE_H
#define ZSPACE_DETAIL_GRAPH_STORAGE_H
...
namespace zSpace
{
	...
	*/
	...
	class ZSPACE_CORE zGraph : public detail::zHalfEdgeTopology
	{
...
#else
#include<src/zCore/geometry/zGraph.cpp>
#endif
