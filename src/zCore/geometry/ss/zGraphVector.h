...
#include <zspace/framework/core/zVector.h>
#include <zspace/framework/core/zMatrix.h>
#include <zspace/framework/core/zColor.h>
#include <zspace/framework/geometry/zGeometryTypes.h>
