...
namespace zSpace
{
	...
	*/
	...
	protected:
		...
		zObjectMeshScalarField  *fieldObj;
	...
	public:
		...
		*	\since version 0.0.3
		*/
		zItMeshScalarField(zObjectMeshScalarField &_fieldObj);
		...
		*	\since version 0.0.3
		*/
		zItMeshScalarField(zObjectMeshScalarField &_fieldObj, int _index);
		...
		*	\since version 0.0.3
		*/
		zItMeshScalarField(zObjectMeshScalarField &_fieldObj, zVector &_pos, bool closestIndex = false);
		...
		*	\since version 0.0.2
		*/
		zItMeshScalarField(zObjectMeshScalarField &_fieldObj, int _index_X, int _index_Y);
	...
	*/
	...
	protected:
		...
		/*!	\brief pointer to a mesh fieldobject  */
		zObjectMeshVectorField *fieldObj;
	...
	public:
		...
		*	\since version 0.0.3
		*/
		zItMeshVectorField(zObjectMeshVectorField &_fieldObj);
		...
		*	\since version 0.0.3
		*/
		zItMeshVectorField(zObjectMeshVectorField &_fieldObj, int _index);
		...
		*	\since version 0.0.3
		*/
		zItMeshVectorField(zObjectMeshVectorField &_fieldObj, zVector &_pos, bool closestIndex = false);
		...
		*	\since version 0.0.2
		*/
		zItMeshVectorField(zObjectMeshVectorField &_fieldObj, int _index_X, int _index_Y);
...
#else
#include<src/zInterface/iterators/zItMeshField.cpp>
#endif
