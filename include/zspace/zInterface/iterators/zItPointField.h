...
namespace zSpace
{
	...
	*/
	...
	protected:
		...
		zObjectPointScalarField  *fieldObj;
	...
	public:
		...
		*	\since version 0.0.3
		*/
		zItPointScalarField(zObjectPointScalarField &_fieldObj);
		...
		*	\since version 0.0.3
		*/
		zItPointScalarField(zObjectPointScalarField &_fieldObj, int _index);
		...
		*	\since version 0.0.3
		*/
		zItPointScalarField(zObjectPointScalarField &_fieldObj, zVector &_pos, bool closestIndex = false);
		...
		*	\since version 0.0.2
		*/
		zItPointScalarField(zObjectPointScalarField &_fieldObj, int _index_X, int _index_Y, int _index_Z);
	...
	*/
	...
	protected:
		...
		/*!	\brief pointer to a mesh fieldobject  */
		zObjectPointVectorField *fieldObj;
	...
	public:
		...
		*	\since version 0.0.3
		*/
		zItPointVectorField(zObjectPointVectorField &_fieldObj);
		...
		*	\since version 0.0.3
		*/
		zItPointVectorField(zObjectPointVectorField &_fieldObj, int _index);
		...
		*	\since version 0.0.3
		*/
		zItPointVectorField(zObjectPointVectorField &_fieldObj, zVector &_pos, bool closestIndex = false);
		...
		*	\since version 0.0.2
		*/
		zItPointVectorField(zObjectPointVectorField &_fieldObj, int _index_X, int _index_Y);
...
#else
#include<src/zInterface/iterators/zItPointField.cpp>
#endif
