...
#ifndef ZSPACE_OBJECT_COMPUTEMESH_H
#define ZSPACE_OBJECT_COMPUTEMESH_H
...
#include<zspace/zInterface/objects/zObjectParticle.h>
...
namespace  zSpace
{
	...
	*/
	...
	class ZSPACE_API zObjectComputeMesh : public zObject
	{
...
#else
#include<src/zInterface/objects/zObjectComputeMesh.cpp>
#endif
