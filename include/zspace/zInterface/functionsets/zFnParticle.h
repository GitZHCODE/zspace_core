...
namespace zSpace
{
	...
	*/
	...
	class ZSPACE_API zFnParticle : public zFn
	{
	protected:
		//--------------------------
	...
	public:
		...
		*	\since version 0.0.2
		*/
		zFnParticle(zObjectParticle &_particleObj);
...
#else
#include<src/zInterface/functionsets/zFnParticle.cpp>
#endif
