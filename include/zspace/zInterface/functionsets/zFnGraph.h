...
namespace zSpace
{
	...
	*/
	...
	class ZSPACE_API zFnGraph : public zFn
	{	
	...
	public:
		...
		*/
		...
		/*! \brief Returns the attached graph object, or nullptr when detached. */
		zObjectGraph* object() const;
...
#else
#include<src/zInterface/functionsets/zFnGraph.cpp>
#endif
