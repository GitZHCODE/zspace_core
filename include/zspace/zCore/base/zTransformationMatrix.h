	...
	*/
	...
	public:
		...
		*/
		...
		zTransformationMatrix(const zTransformationMatrix& other);
		zTransformationMatrix(zTransformationMatrix&& other) noexcept;
		zTransformationMatrix& operator=(const zTransformationMatrix& other);
		zTransformationMatrix& operator=(zTransformationMatrix&& other) noexcept;
...
#else
#include<src/zCore/base/zTransformationMatrix.cpp>
#endif
