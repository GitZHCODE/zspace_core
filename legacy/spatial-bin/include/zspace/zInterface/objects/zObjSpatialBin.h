...
#include <zspace/zCore/field/zBin.h>
...
namespace zSpace
{
	...
	*/
	...
	/*! \brief Transitional keyword-first public spatial-bin object name. */
	using zObjectSpatialBin = zObjSpatialBin;
...
#else
#include<src/zInterface/objects/zObjSpatialBin.cpp>
#endif
