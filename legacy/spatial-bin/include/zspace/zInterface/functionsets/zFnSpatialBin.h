...
namespace  zSpace
{
	...
	*/
	...
	{
		zVector minBB, maxBB;
		minBB = binObj->field.minBB;
		maxBB = binObj->field.maxBB;

		zVector minBB_Obj, maxBB_Obj;
		zFnPointCloud(inObj).getBounds(minBB_Obj, maxBB_Obj);
	...
	inline bool zFnSpatialBin::boundsCheck(zObjGraph &inObj)
	{
		...
		zVector minBB_Obj, maxBB_Obj;
		zFnGraph(inObj).getBounds(minBB_Obj, maxBB_Obj);
	...
	inline bool zFnSpatialBin::boundsCheck(zObjMesh &inObj)
	{
		...
		zVector minBB_Obj, maxBB_Obj;
		zFnMesh(inObj).getBounds(minBB_Obj, maxBB_Obj);
...
#else
#include<src/zInterface/functionsets/zFnSpatialBin.cpp>
#endif
