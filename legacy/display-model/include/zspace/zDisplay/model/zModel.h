...
#pragma once
#include <zspace/zInterface/objects/zObj.h>
...
namespace zSpace
{
	...
	*/
	...
	public:
		...
		/*! \brief scene display context */
		zDisplayScene displayScene;
...
#else
#include<src/zDisplay/model/zModel.cpp>
#endif
